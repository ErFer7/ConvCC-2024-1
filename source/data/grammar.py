...
ONE_CHAR_DEFINITIVE_TERMINALS = [
    Terminal.OPEN_P, Terminal.CLOSE_P, Terminal.OPEN_SB, Terminal.CLOSE_SB,
    Terminal.OPEN_CB, Terminal.CLOSE_CB, Terminal.COMMA, Terminal.SEMICOLON, Terminal.MULTIPLY,
    Terminal.DIVISION, Terminal.REMAINDER, Terminal.ADDITION, Terminal.SUBTRACT
]
